...
public: 
  ...
  void control_arcade();
  void control_arcade(float throttleMultiplier, float turnMultiplier);
  void control_arcade(float throttleMultiplier, float turnMultiplier, float throttleDeadzone, float turnDeadzone);
  void control_tank();
